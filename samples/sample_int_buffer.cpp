...
int main(int argc, char *argv[])
{
  ...
  std::cout << "Pushing back data in buffer\n";
  ...
  int_buff.pop_front();
  std::cout << "pop front executed new size: " << int_buff.size() << " new front:" << int_buff.front() << "\n";
  ...
  for (const auto &it : int_buff) std::cout << "Checking range based for loop function  " << it << "\n";
